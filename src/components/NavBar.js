  ...
  return (
    <header className='w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
      <button data-testid="navbar-button" className='flex-col justify-center items-center hidden lg:flex' onClick={handleClick}>
        <span className={`bg-dark dark:bg-light block transition-all duration-300 ease-out e h-0.5 w-6 rounded-sm ${isOpen ? "rotate-45 translate-y-2" : "-translate-y-0.5"}`}></span>
